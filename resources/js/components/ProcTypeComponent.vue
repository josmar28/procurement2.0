<template>
    <div class="col-12">
        ...
        <div class="card-body">
            ...
            <h4 class="card-title">Procure Type List</h4>
                <div style="margin-bottom:20px;">
                    <button type="button"
                    class="btn waves-effect waves-light btn-rounded btn-success" @click="create_pr_type()">Create Type</button>
                </div>
        ...
        <div id="create_pr_type_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="success-header-modalLabel" aria-hidden="true">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="form-actions">
                                                    <div class="text-right">
                                                        <button class="btn btn-info" @click="pr_type_submit()">Submit</button>
                                                    </div> 
                                                </div>
                                            </div>
                                        </div>
...
export default{
    ...
    methods: {
        create_pr_type(){
            ...
            vm.form.id = null,
            vm.form.type = null,
            $('#create_pr_type_modal').modal('show');
        },
        ...
        pr_type_submit()
        {
            const vm = this;
            axios
                .post('/procurement2.0/procurement/procuretype/add', this.form)
        ...
        remove(dat)
        {
            ...
            callback: confirm => {
                if (confirm) {
                    axios
                        .post('/procurement2.0/procurement/procuretype/remove',{
                            id : dat.id
                        })
                        .then(function(response){
