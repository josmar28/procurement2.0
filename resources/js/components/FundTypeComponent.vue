<template>
    <div class="col-12">
        ...
        <div class="card-body">
            ...
            <h4 class="card-title">Fund Type List</h4>
                <div style="margin-bottom:20px;">
                    <button type="button"
                    class="btn waves-effect waves-light btn-rounded btn-success" @click="create_type()">Create Type</button>
                </div>
        ...
        <div id="create_type_modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="success-header-modalLabel" aria-hidden="true">
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" placeholder="Input Here..." v-model="form.fundtype" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-actions">
                                                    <div class="text-right">
                                                        <button class="btn btn-info" @click="type_submit()">Submit</button>
                                                    </div> 
                                                </div>
                                            </div>
                                        </div>
    ...
    methods: {
        ...
        remove(dat)
        {
            ...
            callback: confirm => {
                if (confirm) {
                    axios
                        .post('/procurement2.0/procurement/fundtype/remove',{
                            id : dat.id
                        })
                        .then(function(response){
